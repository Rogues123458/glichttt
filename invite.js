...
client.on("guildMemberAdd", (member) => {
    ...
    guild.fetchInvites().then(invites => {
        ...
        if(invite == guild.vanityURLCode) content = settings.defaultMessage ? settings.defaultMessage : `Sunucuya Katılan: -member-, Kim Davet Etti Bulamıyorum.`;
        else content = settings.welcomeMessage ? settings.welcomeMessage : `Sunucuya Katılan: -member-, Davet Eden: -target-.`;
